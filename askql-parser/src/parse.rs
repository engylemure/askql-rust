...
mod tests {
    ...
    fn test_single_quote_string() {
        ...
        assert_eq!(
            repl.unwrap(),
            AskCodeOrValue::new_value(Value::String("HelloWorld!".to_string()))
        );
    }
    ...
    fn test_int_number() {
        ...
        assert_eq!(
            repl.unwrap(),
            AskCodeOrValue::new_value(Value::number("4".to_string()))
        );
    }
    ...
    fn test_float_number() {
        ...
        assert_eq!(
            repl.unwrap(),
            AskCodeOrValue::new_value(Value::number("4.2".to_string()))
        );
    }
    ...
    fn test_expression() {
        ...
        assert_eq!(
            repl.unwrap(),
            AskCodeOrValue::new_ask_code(AskCode::new("scorePerPhilosopher".to_string(), None))
        );
    }
    ...
    fn test_nested_expression() {
        ...
        assert!(repl.is_ok());
        let score_per_philosopher =
            AskCodeOrValue::new_ask_code(AskCode::new("scorePerPhilosopher".to_string(), None));
        let max = AskCodeOrValue::new_ask_code(AskCode::new(
            "max".to_string(),
            Some(vec![score_per_philosopher]),
        ));
